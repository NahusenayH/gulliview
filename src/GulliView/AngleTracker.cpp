...
void AngleTracker::add_number(float number) {
...
float AngleTracker::get_max_value(int epsilon) {
...
void AngleTracker::remove_old_elements() {
...
void AngleTracker::update_average(float number) {
